...
- nemo8b, mistral, and qwen25 benchmark logs (and RAG/rerank sanity logs) are recorded in `reports/benchmark_nemo8b.txt`, `reports/benchmark_mistral.txt`, `reports/benchmark_qwen25.txt`, and `reports/rag_rerank_sanity.txt`.
