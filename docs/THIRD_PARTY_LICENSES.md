# Third-Party Licenses (Runtime Evidence)
...
## Core framework and tooling (Python packages)
- langchain 1.1.0 — MIT
- langgraph 1.0.4 — MIT
- langchain-core 1.1.0 — MIT
- langchain-community 0.4.1 — MIT
- langchain-chroma 1.0.0 — MIT
- langchain-ollama 1.0.0 — MIT
- chromadb 1.3.5 — Apache Software License
- ollama 0.6.1 — MIT
- BCEmbedding 0.1.5 — apache-2.0
