...
from priorauth.policy_utils import normalize, format_criteria_list
from priorauth.letter_service import LetterResult, generate_approved_letter, generate_appeal_letter
from priorauth.audit_logger import get_audit_logger  # noqa: E402

# ---- Optional reranker (safe-to-import wrapper) ----
# This module is designed to not blow up imports if BCEmbedding isn't installed.
from priorauth.bce_reranker import rerank_bce  # noqa: E402

# ---- Central config ----
from priorauth.config import (  # noqa: E402
    APPEAL_MODEL_NAME,
    AUDIT_MODEL_FLAVOR,
    AUDIT_MODEL_NAME,
    AUDIT_MODEL_OPTIONS,
...
from priorauth.policy_constants import (  # noqa: E402
    AMBIGUOUS_APPEAL_TERMS,
    BMI_OBESE_THRESHOLD,
    BMI_OVERWEIGHT_THRESHOLD,
)
from priorauth.policy_engine import _parse_bmi, evaluate_eligibility  # noqa: E402
from priorauth.policy_snapshot import SNAPSHOT_PATH, load_policy_snapshot  # noqa: E402
from priorauth.schema_validation import validate_policy_snapshot  # noqa: E402
...
from priorauth.config import PA_ENABLE_RERANK as ENABLE_RERANK
...
_DATA_DIR = Path(os.getenv("ETL_OUTPUT_DIR", str(paths.OUTPUT_DIR)))
...
def _ensure_vectorstore():
    if not os.path.isdir(PERSIST_DIR):
        raise RuntimeError(
            ...
            "Run `python -m priorauth.apps.agent.setup_rag` to build the policy index."
        )
